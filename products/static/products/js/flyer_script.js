...
document.addEventListener('DOMContentLoaded', function() {
    ...
    sideType.addEventListener('change', showProducts)
...
// ------------------------------------------------------------
    function createProductCard(product) {
        ...
        <div class="product-details">
            ...
            <p><strong>تک رو / دو رو: </strong> ${product.side_type}</p>
    ...
    function showProducts() {
        ...
        const selectedSideType = sideType.value;
        ...
        currentProducts = productsData.filter(product => {
            ...
            const matchesSideType = selectedSideType === 'all' || product.side_type === selectedSideType;
            const matchesCirculation = selectedCirculation === 'all' || product.circulation === parseInt(selectedCirculation);
            
            return matchesPaperType && matchesSize && matchesColorMode && matchesSideType && matchesCirculation;
        });
