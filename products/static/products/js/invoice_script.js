...
// ------------------------------------------------------------
    function createProductCard(product) {
        ...
        <div class="product-details">
            ...
            <p><strong>نوع:</strong> ${product.invoice_type}</p>
    ...
    function showProducts() {
        ...
        const selectedInvoiceType = invoiceType.value;
        ...
        currentProducts = productsData.filter(product => {
            ...
            const matchesInvoiceType = selectedInvoiceType === 'all' || product.invoice_type === selectedInvoiceType;
            const matchesCirculation = selectedCirculation === 'all' || product.circulation === parseInt(selectedCirculation);
            
            return matchesPaperType && matchesSize && matchesColorMode && matchesInvoiceType && matchesCirculation;
        });
